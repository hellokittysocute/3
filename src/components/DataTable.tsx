        ...
        <table className="w-full text-left border-collapse min-w-[2900px]">
          <thead className="bg-slate-50 border-b border-slate-200 sm:sticky sm:top-0 sm:z-30">
            <tr className="text-[13px] font-bold text-slate-500 uppercase tracking-tight whitespace-nowrap" onContextMenu={handleHeaderContext}>
              ...
              <SortableTh sortKey="createdDate" sortConfig={sortConfig} onSort={handleSort} className="px-2 py-2 border-r border-slate-200 w-[62px] text-center bg-slate-100">생성일</SortableTh>
              <SortableTh sortKey="originalDueDate" sortConfig={sortConfig} onSort={handleSort} className="px-2 py-2 border-r border-slate-200 w-[62px] text-center bg-slate-100">원납기일</SortableTh>
              <SortableTh sortKey="changedDueDate" sortConfig={sortConfig} onSort={handleSort} className="px-2 py-2 border-r border-slate-200 w-[62px] text-center bg-slate-100">변경납기일</SortableTh>
